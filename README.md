...
To use, excecute the content of the ui.r and server.r in R after installing all required packages. The result should mirror the application hosted here https://cutt.ly/uQpTVky which due to computation power only works offline.
